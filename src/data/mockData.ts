  ...
  children: [
    {
      ...
      name: "Moaz Akram",
      level: 2,
      imageUrl: "/images/talk-curator.jpeg",
      ...
      memberBio: "",
      children: [
        { id: "exec-coaching", title: "Coaching", name: "Ammar Ibrahim", level: 3, imageUrl: "/images/coaching.jpeg", description: "Guiding speakers through intensive coaching.", committeeDescription: "Coaching works closely with each speaker to refine their narrative arc, improve delivery, and build confidence for the stage.", memberBio: "" },
        { id: "exec-research", title: "Research & Production", name: "Abdulrahman Waleed", level: 3, imageUrl: "/images/R&P.jpeg", description: "Researching cutting-edge topics and managing production.", committeeDescription: "Research & Production ensures every talk is backed by credible sources and produced with professional-grade quality.", memberBio: "" },
      ],
    },
    {
      id: "curator-operations",
      ...
      name: "Kareem Roshdy",
      level: 2,
      imageUrl: "/images/operations.jpeg",
      ...
      memberBio: "",
      children: [
        { id: "exec-events", title: "Events Management", name: "Laila El-Hadidy", level: 3, imageUrl: "/images/events management.jpeg", description: "Coordinating all event logistics and attendee experience.", committeeDescription: "Events Management designs the full attendee journey from registration to closing, including interactive experiences and networking sessions.", memberBio: "" },
        { id: "exec-partnerships", title: "Partnerships", name: "Hamza El-Khobby", level: 3, imageUrl: "/images/partnerships.jpeg", description: "Securing strategic partnerships and sponsor relations.", committeeDescription: "Partnerships builds and maintains relationships with corporate sponsors, media partners, and community organizations.", memberBio: "" },
        { id: "exec-logistics", title: "Logistics", name: "Abdallah Nazih", level: 3, imageUrl: "/images/logistics.jpeg", description: "Managing all on-ground logistics and vendor coordination.", committeeDescription: "Logistics handles the physical infrastructure — equipment, catering, transportation, signage, and venue preparation.", memberBio: "" },
      ],
    },
    {
      id: "curator-od",
      ...
      memberBio: "",
      children: [
        { id: "exec-assoc-dev", title: "Associate Development", name: "Rohanda Ahmed", level: 3, imageUrl: "/images/associate development.jpeg", description: "Creating growth opportunities and mentorship programs.", committeeDescription: "Associate Development designs onboarding tracks, skill-building workshops, and career mentorship for all new associates.", memberBio: "" },
        { id: "exec-assoc-exp", title: "Associate Experience", name: "Abdullah Abosamra", level: 3, imageUrl: "/images/Associate experience.jpeg", description: "Designing engaging team experiences and well-being initiatives.", committeeDescription: "Associate Experience ensures every team member feels valued through social events, recognition programs, and well-being support.", memberBio: "" },
      ],
    },
    {
      id: "curator-marketing",
      ...
      memberBio: "",
      children: [
        { id: "exec-media", title: "Media & Design", name: "Farida Sabrah", level: 3, imageUrl: "/images/media and design.jpeg", description: "Producing visual storytelling content across all platforms.", committeeDescription: "Media & Design creates the visual identity of TEDxGUC — social media graphics, event branding, video production, and stage visuals.", memberBio: "" },
        { id: "exec-campaigns", title: "Campaigns & Copy", name: "Malak Hatem", level: 3, imageUrl: "/images/CC.jpeg", description: "Crafting compelling narratives and managing multi-channel campaigns.", committeeDescription: "Campaigns & Copywriting develops the voice of TEDxGUC — from taglines and social captions to email newsletters and press releases.", memberBio: "" },
      ],
    },
  ],
};
